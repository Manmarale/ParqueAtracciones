...
public class Atraccion {
    ...
    public Atraccion(String nombre, Integer capacidadMaxima, String estado){ //constructor de Atracción
        this.nombre = nombre;
    ...
    public void iniciarAtraccion(){ //método para iniciar una atracción
        System.out.println("La atraccion " + nombre + "Esta siendo iniciada");
        
    }
    public void detenerAtraccion(){ //método para detener una atracción
